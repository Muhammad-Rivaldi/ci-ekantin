                      ...
                      <div class="col-lg-4 mb-4">
                        <div class="card" style="width: 18rem;">
                          ...
                          <div class="card-body">
                            ...
                            <a class="btn btn-sm btn-primary" href="<?php echo site_url('ekantin_controller/admin_menu') ?>"><i class="fa fa-search-plus"></i>edit</a>
                            <a class="btn btn-sm btn-danger" href="<?php echo site_url('ekantin_controller/admin_menu') ?>"><i class="fa fa-trash"></i>delete</a>
                          </div>
                        </div>
                      </div>
                    <?php
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; e-kantin 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
